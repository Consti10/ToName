...
import com.lrz.MarkerBasedARFragment;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
        ...
        //    .setSource(this,R.raw.bayern_map_low)
            .setSource(this,R.raw.autobahn_textures_unwrapped) //R.raw.autobahn_textures_unwrapped
    ...
    arFragment.setOnTapArPlaneListener(
        (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
          ...
          model.getScaleController().setMinScale(0.01f);
            model.getScaleController().setMaxScale(10);
